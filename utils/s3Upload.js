...
const uploadImageOrPdf = async (file, folderName) => {
  if (!file || !file.buffer || !file.originalname) {
    throw new Error("Invalid file upload");
  }

  // Validate file type (images: PNG, JPEG, JPG; PDFs)
  ...
  if (!allowedMimeTypes.includes(contentType)) {
    throw new Error("File must be an image (PNG, JPEG, JPG) or PDF");
  }
...
module.exports = { uploadImageToS3, deleteFromS3, updateFromS3, uploadMultipleImagesToS3 ,uploadImageOrPdf};
